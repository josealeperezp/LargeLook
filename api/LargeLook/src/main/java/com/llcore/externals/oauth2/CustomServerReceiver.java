 ...
 */
package com.llcore.externals.oauth2;
 ...
 * @author Yaniv Inbar
 */
public final class CustomServerReceiver implements VerificationCodeReceiver {
   ...
   */
  public CustomServerReceiver(String host, int port) {
    this.host = host;
    this.port = port;
  }
  ...
  public static final class Builder {
    ...
    public CustomServerReceiver build() {
      return new CustomServerReceiver(host, port);
    }
